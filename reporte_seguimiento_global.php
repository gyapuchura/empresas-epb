...
<?php
$numero=1;
$sql =" SELECT corres.idcorres, corres.origen, corres.referencia, corres.procedencia, corres.fecha_corres, corres.codigo, corres.idestado, corres.correlativo, tipo_hojaruta.tipo_hojaruta, estado.estado FROM corres, tipo_hojaruta, estado ";
