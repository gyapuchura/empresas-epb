...
<form name="VOLVER" action="legajos_permanentes.php" method="post">
...
<div class="row">
<div class="col-md-12"><h2>4.1.1.- LEGISLACIÓN VINCULADA A LA INSTITUCIÓN </h2></div>
</div>
<div class="row">
<div class="col-md-12">
<div class="container contenido">
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col"><h5>LEY/DECRETO/RESOLUCIÓN N°</h5></th>
      <th scope="col"><h5>FECHA DE APROBACION</h5></th>
      <th scope="col"><h5>OBJETIVO</h5></th>
...
<?php
$contador=1;
$sql =" SELECT idlegislacion, idlegajo, ley, fecha_aprob, objetivo ";
$sql.=" FROM legislacion WHERE idlegajo='$idlegajo_ss' ";
...
?>    
      ...
      <td>
            <form name="BORRA" action="elimina_item_leg.php" method="post">
...
<div class="row">
<h4>INGRESAR DATOS DE LA LEGISLACIÓN </h4>
</div>
<div class="row">
<div class="col-md-12"><p>Incluye resumen de las disposiciones, segun el cuadro. </p></div>
</div>
<div class="box-area">
<div class="row">
  
<form method="post" action="guarda_legislacion.php" >
    <div class="col-md-4"><h4>LEY/DECRETO/RESOLUCIÓN N°:</h4></div>
      <div class="col-md-3">
      <input type="text" id="ley" class="form-control" name="ley">      
      </div>  
      <div class="col-md-3"><h4>FECHA DE APROBACIÓN:</h4></div>
      <div class="col-md-2">
      <input type="text" id="fecha1" class="form-control" name="fecha_aprob">
      </div>    
    </div>

<div class="row">
<div class="col-md-3"><h4>OBJETIVO:</h4></div>
<div class="col-md-9"><textarea class="form-control" rows="3" name="objetivo"></textarea></div>
</div> 
...
<!----- modal de GUARDADO DE ITEM ---->
    ...
    <div class="col-md-8">
      ...
      <div class="col-md-4">
      <a href="relaciones_tuicion.php"><h4 class="text-primary">CONTINUAR</h4></a>
      </div>
    </div>
