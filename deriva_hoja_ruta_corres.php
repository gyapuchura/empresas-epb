...
<div class="col-md-6"><h2 class="text-muted"><?php echo $row1[14];?></h2></div>
<div class="col-md-2">

<form name="DATOSHR" action="datos_Hojaruta.php" method="post">
<h4><button type="submmit" class="btn-link" >INGRESAR DATOS DEL TRÁMITE</button></h4>
</form>
