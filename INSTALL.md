...
luego clonar el respositorio con el siguiente comando
		...
		git clone https://github.com/gyapuchura/empresas-epb.git


## ACTUALIZAR EL CODIGO FUENTE DEL SERVIDOR DE APLICACION

Dirrigise al directorio /var/www/html/empresas-epb

ejecutar:

		cd /var/www/html/empresas-epb

luego clonar la actualizacion del respositorio con el siguiente comando

		git pull https://github.com/gyapuchura/empresas-epb.git
...
Guardando los cambios y usando un navegador de internet usando la direccion:
                              ...
                              http://[ip o direccion de dominio]/empresas-epb/
