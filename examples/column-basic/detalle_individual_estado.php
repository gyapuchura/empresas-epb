...
<?php
$numero=1;
$sql =" SELECT corres.idcorres FROM corres, deriva_corres WHERE corres.idcorres=deriva_corres.idcorres AND ";
$sql.=" deriva_corres.idusuariod='$idusuario_rep' AND corres.idestado='$idestado' GROUP BY deriva_corres.idcorres  ";
