...
$sql.=" FROM corres, tipo_hojaruta WHERE corres.idtipo_hojaruta=tipo_hojaruta.idtipo_hojaruta AND corres.gestion='$gestion' AND corres.idestado='$idestado' ORDER BY corres.idcorres ";
$result = mysqli_query($link,$sql);
