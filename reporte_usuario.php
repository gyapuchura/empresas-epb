...
<input type="hidden" name="idusuario_rep" value="<?php echo $idusuario_rep;?>">
 ...
 <a href="detalle_individual.php?idusuario_rep=<?php echo $idusuario_rep;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=850,scrollbars=YES,top=50,left=200'); return false;">IMPRIMIR DETALLE INDIVIDUAL</a>  
...
$row4 = mysqli_fetch_array($result4);
    ?>
        ...
        <td>          
	  <a href="imprime_ficha_control.php?idcorres=<?php echo $row[0]?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=850,scrollbars=YES,top=50,left=200'); return false;"><h5 class="text-warning">FICHA DE CONTROL</h5></a>    
    <a href="imprime_hoja_ruta_ver.php?idcorres=<?php echo $row[0]?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=850,scrollbars=YES,top=50,left=200'); return false;">HOJA RUTA COMPLETA</a>  
