...
$sql.=" corres.anexo, estado.estado, corres.codigo, ubicacion_archivo.ubicacion_archivo, corres.fecha_archivo, usuarios.usuario, entidad_archivo.entidad_archivo FROM corres, ubicacion_archivo, estado, usuarios, entidad_archivo ";
$sql.=" WHERE corres.idubicacion_archivo=ubicacion_archivo.idubicacion_archivo AND corres.idestado=estado.idestado AND corres.usr_archivo=usuarios.idusuario AND ubicacion_archivo.identidad_archivo=entidad_archivo.identidad_archivo AND corres.idestado='4' ORDER BY corres.idcorres ";
