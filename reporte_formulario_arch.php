...
header("Content-Disposition: attachment; filename=FORMULARIO_ARCHIVO_DOCUMENTAL.xls");
...
$sql.=" item_archivo.no_fojas, cubierta.cubierta, item_archivo.cantidad, item_archivo.descripcion, item_archivo.observaciones FROM item_archivo, serie_documental, cubierta, departamento ";
