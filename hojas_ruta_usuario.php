...
?>
    ...
    <tr>
        ...
        <td>
        <a href="imprime_hoja_ruta_ver.php?idcorres=<?php echo $row2[0]?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=750,height=850,scrollbars=YES,top=50,left=200'); return false;">IMPRIMIR HOJA RUTA COMPLETA</a>  
